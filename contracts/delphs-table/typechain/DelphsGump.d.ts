...
interface DelphsGumpInterface extends ethers.utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "MINTER_ROLE()": FunctionFragment;
    "PAUSER_ROLE()": FunctionFragment;
    "VESTER_ROLE()": FunctionFragment;
    ...
    "rateOfWithdrawl()": FunctionFragment;
    "renounceRole(bytes32,address)": FunctionFragment;
    "revokeRole(bytes32,address)": FunctionFragment;
    "setRateOfWithdrawl(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "rateOfWithdrawl",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setRateOfWithdrawl",
...
export class DelphsGump extends BaseContract {
  ...
  functions: {
    ...
    VESTER_ROLE(overrides?: CallOverrides): Promise<[string]>;
    ...
    rateOfWithdrawl(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    vest(account: string, overrides?: CallOverrides): Promise<void>;
  };
  ...
  estimateGas: {
    ...
    VESTER_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    VESTER_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    rateOfWithdrawl(overrides?: CallOverrides): Promise<PopulatedTransaction>;
