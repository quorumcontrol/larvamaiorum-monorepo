...
export interface EmpireGambitTokenInterface extends utils.Interface {
  functions: {
...
export interface EmpireGambitToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EmpireGambitTokenInterface;
