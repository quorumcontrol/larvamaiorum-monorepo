var TouchInput = pc.createScript('touchInput2');
...
TouchInput.prototype.initialize = function () {
    this.orbitCamera = this.entity.script.orbitCamera2;
...
TouchInput.prototype.pan = function (touch) {
    ...
    camera.screenToWorld(touch.x, touch.y, distance, fromWorldPoint);
