...
console.log("player nifab: ", `https://playcanv.as/p/3eqyo9QZ/?arena=true&m=${Buffer.from(JSON.stringify({...game, id: "0xabc", name: "nifab", avatar: "https://api.readyplayer.me/v1/avatars/63b2a4248596abea61093458.glb"})).toString("base64url")}`)
