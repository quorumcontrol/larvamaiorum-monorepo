...
console.log("player tobowers: ", `https://playcanv.as/p/SP3UNx7J/?debug=true&ministats=true&m=${Buffer.from(JSON.stringify({...game, useAI: true, id: "0x123", name: "tobowers", avatar: "https://api.readyplayer.me/v1/avatars/63a18daedf6a9ef0482c8579.glb"})).toString("base64url")}`)
