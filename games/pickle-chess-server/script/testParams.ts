...
console.log("---- Local Graphics / server AI dev ---- ")
console.log("player tobowers: ", `https://launch.playcanvas.com/1653026?arena=true&debug=true&ministats=true&m=${Buffer.from(JSON.stringify({...game, numberOfHumans: 1, numberOfAi: 1, id: "0x123", name: "tobowers", avatar: "https://api.readyplayer.me/v1/avatars/63a18daedf6a9ef0482c8579.glb"})).toString("base64url")}`)
...
console.log("---- HYPER LOCAL AI dev ---- ")
console.log("player maleDefault: ", `http://localhost:8000?debug=true&ministats=true&m=${Buffer.from(JSON.stringify({...game, numberOfHumans: 1, numberOfAi: 1, id: "0x123", name: "tobowers", avatar: "http://localhost:8000/glb/maledefault.glb"})).toString("base64url")}`)
